...
<head>
    ...
    <?php
        ...
        while ($data = mysqli_fetch_assoc($result)) {
        	...
        	// ipad portrait
            echo "@media (min-width: 750px) and (max-width: 768px) and (min-height: 800px) and (max-height: 1020px) {";
            echo "    $selector {";
			...
			// phone landscape         	
            echo "@media (min-width: 780px) and (max-width: 790px) and (min-height: 284px) and (max-height: 380px)  {";
            echo "    $selector {";
    ...
    <style>
      ...
      /* phone landscape */
      @media (min-width: 780px) and (max-width: 790px) and (min-height: 284px) and (max-height: 380px) {
        body {
            ...
            <div class="row" id="local1">
                <div class="col-sm-4">
                    <button class="categoryBtn btn btn-primary btn-lg btn3d" id='material' value="material">
                        ...
                        <p style=""><span value="material"><?php echo ("(" . $materialCount . ")" ? "(" . $materialTotal . ")" : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn btn btn-primary btn-lg btn3d" id="supply" style="color: #07594f !important;border: 1px solid #7fccc3 !important;" role="button" value="supply">
                        ...
                        <p style=""><span value="supply"><?php echo ("(" . $supplyCount . ")" ? "(" . $supplyTotal . ")" : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn btn btn-primary btn-lg btn3d" id="accessory" role="button" value="accessory">
                        ...
                        <p style=""><span value="accessory"> <?php echo ("(" . $accessoryCount . ")" ? "(" . $accTotal . ")" : ''); ?></span></p>
                    </button>
                </div>
                ...
                <div class="col-sm-4">
                    <button class="categoryBtn btn btn-primary btn-lg btn3d" id="fg" role="button" value="fg">
                        ...
                        <p style=""><span value="fg"><?php echo ("(" . $finishGoodsCount . ")" ? "(" . $fgTotal . ")" : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn btn btn-primary btn-lg btn3d" id="draw" role="button" value='drawing'>
                        ...
                        <p style=""><span value="drawing"><?php echo ("(" . $drawingCount . ")" ? "(" . $drawTotal . ")" : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn btn btn-primary btn-lg btn3d" id="barcode" role="button" value='barcode' disabled>
                        ...
                        <p style=""><span value="barcode"><?php echo ("(" . $drawingCount . ")" ? $drawingCount : ''); ?></span></p>
                    </button>
                </div>
            </div>
            ...
            <div class="row" id="cloud1">
                <div class="col-sm-4">
                    <button class="categoryBtn cloudBtn btn btn-primary btn-lg btn3d" id="video" role="button" value='video'>
                        ...
                        <p style=""><span value='video'><?php echo ("(" . $drawingCount . ")" ? $drawingCount : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn cloudBtn btn btn-primary btn-lg btn3d" id="audio" role="button" value='audio'>
                        ...
                        <p style=""><span value='audio'><?php echo ("(" . $drawingCount . ")" ? $drawingCount : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn cloudBtn btn btn-primary btn-lg btn3d" id="pdf" role="button" value='pdf'>
                        ...
                        <p style=""><span value='pdf'><?php echo ("(" . $drawingCount . ")" ? $drawingCount : ''); ?></span></p>
                    </button>
                </div>
                ...
                <div class="col-sm-4">
                    <button class="categoryBtn cloudBtn btn btn-primary btn-lg btn3d" id="image" role="button" value="image">
                        ...
                        <p style=""><span value='image'><?php echo ("(" . $drawingCount . ")" ? $drawingCount : ''); ?></span></p>
                    </button>
                </div>
                <div class="col-sm-4">
                    <button class="categoryBtn cloudBtn btn btn-primary btn-lg btn3d" id="card" role="button" value="cards">
                        ...
                        <p style=""><span value='cards'><?php echo ("(" . $drawingCount . ")" ? $drawingCount : ''); ?></span></p>
                    </button>
                </div>
            </div>
