    ...
    <div class="row w3-padding-top">
        <div class="col-md-12" style="display: flex; justify-content: space-between;">
            ...
            <div class='w3-center' style="">
                <button id='arkBtn'
                    class='w3-btn w3-round <?php echo ($dwgType == 'ark') ? 'w3-orange' : 'w3-green'; ?>'><b>ARK</b></button>
                <button id='cusBtn'
                    class='w3-btn w3-round <?php echo ($dwgType == 'cus') ? 'w3-orange' : 'w3-green'; ?>'><b>CUS</b></button>
            </div>
            <div class='w3-right'>
                <button data-izimodal-close="" data-izimodal-transitionout="bounceOutDown"
                    class='w3-btn w3-round w3-red'><b>CLOSE</b></button>
            </div>
    ...
    <div class="row w3-padding-top">
        <div class="col-md-12">
            <div class="img-responsive changeContent">
                <iframe id='iframeToChange' style='width: 100%; height: 90vh; border:0;' src="<?php echo $src; ?>"
